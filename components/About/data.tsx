export const data = [
  {
    ...
    description: `Cryptocurrencies, NFT, Metaverse, DAO, E-commerce, Real estate? If
  ...
  },
  {
    ...
    description: `Programming, trading, analysis & research, education, law, UX/UI
  ...
  },
  {
    ...
    description: `Would you like to find a co-founder, talent to join your team, or
